...
class ReservaService:
    ...
    def _assert_integridad(self, curso_id: int, horario_id: int) -> None:
    ...
    def update(self, reserva_id: int, payload: ReservaUpdate) -> ReservaOut:
        ...
        # - Si pasa de NO cancelada -> cancelada: liberar cupo
        # - Si pasa de cancelada -> NO cancelada: consumir cupo (si hay)
