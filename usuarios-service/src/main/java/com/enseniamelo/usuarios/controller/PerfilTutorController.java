...
public class PerfilTutorController {
        ...
        @Operation(summary = "Buscar tutor por ID (Mongo)")
        @ApiResponses(value = {
        ...
        public Mono<ResponseEntity<PerfilTutorDTO>> buscarPorId(
                        @Parameter(description = "ID de MongoDB del tutor", required = true) @PathVariable String idTutor) {
        ...
        @Operation(summary = "Buscar perfil de tutor por ID de usuario (Mongo)")
        @ApiResponses(value = {
        ...
        public Mono<ResponseEntity<PerfilTutorDTO>> actualizarClasificacion(
                ...
                log.info("PATCH /v1/tutores/{}/clasificacion - Actualizando clasificación a {}", idTutor,
                                clasificacion);
