...
const ReviewsSection = ({
    ...
    const handleSubmit = async (e) => {
        ...
        if (!cuerpo.trim()) {
            showNotification({ type: "warning", title: "Campos incompletos", message: "Por favor completa el comentario" });
            return;
        }
        ...
        <section className="infocurso-reviews-section">
            ...
            {puedeResenar && !yaReseno ? (
                ...
                <p className="infocurso-review-hint">
                    Solo puedes dejar una reseña por curso y únicamente cuando tu reserva haya sido confirmada y la fecha de la clase ya haya pasado.
                </p>
            )}
        </section>
    );
